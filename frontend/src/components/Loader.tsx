...
export const Loader: React.FC<IProps> = ({isFull = true, className}) => {
    return (
        <LoaderContainer isFull={isFull} className={className}>
...
const LoaderContainer = styled.span<{isFull: boolean}>`
